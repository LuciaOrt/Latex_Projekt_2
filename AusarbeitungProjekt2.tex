...
Diese Analyse ergibt, dasselbe wie für das P2PGK- Problem mit Bedarfsfaktor $d$, da dieselben Kunden mit Glasfaser angeschlossen werden müssen. Zum Beispiel bei der Instanz Vehlefanz werden bei $d=3,5$ bei P2P und P2MP 40 Kunden angeschlossen.
...
Diese Nebenbedingung ist ebenfalls wie bei der Erweiterung des P2P Problems notwendig, da sonst alle Kanten $ij$ mit negativen Kosten ausgewählt werden und die Nebenbedingung dies verhindert, da nun nur die Kanten ausgew\"ahlt werden können, welche auch wirklich in dem Fluss vorkommen.
 ...
 Im Gegensatz zum P2PGK Problem (bei diesem wurde erst nach 40 Jahren ein Kunde mehr mit Glasfaser angeschlossen) werden bei Berlin bereits nach 10 Jahren schon 5 Kunden mit Glasfaser angeschlossen. Die Anzahl steigt dennoch recht langsam. Da ein Zeitraum von 30 oder gar 40 Jahren den \"ublichen Planungshorizont eines Telekommunikationsunternehmens \"ubersteigt, sollte das Unternehmen diese Profite der verschiedenen Anschlusstechnologien nicht ber\"ucksichtigen.  Das heißt, es sollten eventuell nun 7 Kunden anstatt 3 mit Glasfaser angeschlossen werden, aber nicht 24, wie nach 40 Jahren.
...
%[[1, 0, 'B_551', 474909.2763945444, 3, False], [1.5, 0, 'B_551', 543177.4626992824, 10, False]]
...
\end{table}
 ...
 %[[1, 120, 'B_551', 316320.1825676254, 5, False], [1, 240, 'B_551', 145851.09768581862, 7, False], [1, 360, 'B_551', -34146.171900880116, 15, False], [1, 480, 'B_551', -235002.5316262613, 24, False]]
