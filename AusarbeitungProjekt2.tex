...
\end{align*}
Diese Nebenbedinungen ist notwendig, da sonst alle Kanten $ij$ mit negativen Kosten ausgewählt werden. Die Nebenbedinungen verhindert dies, da nun nur die Kanten ausgewählt werden können, welche auch wirklich in dem Fluss vorkommen.
